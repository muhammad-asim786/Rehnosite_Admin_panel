...
import 'book_service_mainList.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              // color: Colors.red,
              child: StreamBuilder(
                stream: model.databaseService.bookServiceRequestDB.snapshots(),
                  ...
                  if (!snapshot.hasData) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        DocumentSnapshot bookService =
                            snapshot.data!.docs[index];

                        if (searchSiteName.isEmpty) {
                          return BookServiceMainListView(
                            index: index,
                            site: bookService,
                          );
                        } else if (bookService["Current site"]
                            .toString()
                            .toLowerCase()
